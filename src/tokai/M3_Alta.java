 ...
 * @author hinse
 */
public class M3_Alta extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            if(B2 != null){
                CallableStatement BD2 = B2.prepareCall("{Call AltaSucursal(?,?,?,?,?)}");
                BD2.setString(1, jNombre.getText());
