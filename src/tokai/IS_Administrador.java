 ...
 * @author hinse
 */
public class IS_Administrador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bienvenido Admin TOKAI");
    ...
    private void jEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jEntrarActionPerformed
        ...
        F1 = Conexion.conexion("SQL", "sa", "180926", "TOKAI");
        if(F1 != null){
            try{
                PreparedStatement BD = F1.prepareStatement("select * from Administrador "
                    + "where No_Usuario = ? and Pass = ?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IS_Administrador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IS_Administrador().setVisible(true);
            }
        });
    }
